var Room1 = {
    ...
    create: function () {
        ...
        if(room1un == false){
            ...
            this.locker = game.add.sprite(554, game.world.height-60, 'lock');
    ...
    started: function() {
        ...
        Room1.text1 = game.add.text(75, 35, '(Для передвижения кликайте на стрелки и лестничные проёмы.', { fontSize: '20px', fill: '#FFF', font: 'bold 20pt sans' });
        Room1.text2 = game.add.text(75, 75, 'Для действия кликайте на обьекты, но знайте, что не все', { fontSize: '20px', fill: '#FFF', font: 'bold 64pt sans' });
        Room1.text3 = game.add.text(75, 115, 'объекты взаимодействуют, иные будут отмечены сиянием.', { fontSize: '20px', fill: '#FFF', font: 'bold 64pt sans' });
        Room1.text4 = game.add.text(75, 155, 'Заблокированные и предметы с подвохом тоже будут отмечены.)', { fontSize: '20px', fill: '#FFF', font: 'bold 64pt sans' });
