var Menu = {
    ...
    create: function () {
        ...
        this.text = game.add.text(210, 575, 'UNDERQUESTRIA V0.24 (C) DISCORDINGAMES 2019', { fontSize: '15px', fill: '#888', font: 'bold 15pt Pixel' });
        this.text = game.add.text(175, 555, '"UNDERTALE" & "MY LITTLE PONY" Сrossover (FAN-MADE)', { fontSize: '15px', fill: '#111', font: 'bold 15pt Pixel' });
    ...
    booped:function(){
        ...
        this.ebtn.inputEnabled = true;
        this.ebtn.scale.setTo(0.5, 0.5);
        this.ebtn.events.onInputDown.add(Menu.boop);
    },
}
