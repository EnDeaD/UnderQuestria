var Menu = {
    preload: function () {
        ...
        game.load.image('july', 'assets/pony.png');
        game.load.image('boop', 'assets/boop.png');
    ...
    create: function () {
        ...
        this.ebtn = game.add.sprite(355, 385, 'july');
        ...
        this.text = game.add.text(210, 580, 'UNDERQUESTRIA V0.45 (C) DISCORDINGAMES 2019', { fontSize: '15px', fill: '#808080', font: 'bold 15pt Pixel' });
        this.text = game.add.text(175, 560, '"UNDERTALE" & "MY LITTLE PONY" Сrossover (FAN-MADE)', { fontSize: '15px', fill: '#404040', font: 'bold 15pt Pixel' });
    ...
    boop:function(){
        Menu.ebtn.kill();
        Menu.bbtn = game.add.sprite(355, 385, 'boop');
    ...
    booped:function(){
        Menu.bbtn.kill();
        Menu.ebtn = game.add.sprite(355, 385, 'july');
