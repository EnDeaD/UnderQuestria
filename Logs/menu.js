var Menu = {
    ...
    create: function () {
        ...
        this.text.inputEnabled = true;
        this.text = game.add.text(200, 150, 'July', { fontSize: '30px', fill: '#FFF', font: 'regular 64pt Comic Sans MS' });
        this.text.inputEnabled = true;
        this.text = game.add.text(375, 150, 'LV 0', { fontSize: '30px', fill: '#FFF', font: 'regular 32pt Arial' });
        this.text.inputEnabled = true;
