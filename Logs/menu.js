var Menu = {
    ...
    create: function () {
        ...
        this.word = game.add.sprite(10, 530, 'btn');
        this.word.inputEnabled = true;
        this.word.scale.setTo(0.2)
        this.word.events.onInputDown.add(this.words);

        this.inf = game.add.sprite(730, 530, 'btn');
        this.inf.inputEnabled = true;
        this.inf.scale.setTo(0.2)
        this.inf.events.onInputDown.add(this.info);

        this.mor = game.add.sprite(730, 10, 'btn');
